...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Heebo:wght@400;500;600&family=Lobster&family=Nunito:wght@600;700&family=Rubik&display=swap" rel="stylesheet">
...
<body>
  ...
  <!-- About Food Kita -->
  <section class="main animate__animated animate__fadeInDown" >
  ...
  <section class="animate__animated animate__fadeInDown">
    <div class="container m-5" style="width: -webkit-fill-available;">
      <h3 class="text-center">Location</h3>
      <div class="row g-2">
          <div class="google-map col-4">

            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3953.964937877668!2d110.4143109086833!3d-7.686911771736357!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a5f2453927085%3A0x2ed34ddad1b94c1f!2sUniversitas%20Islam%20Indonesia!5e0!3m2!1sen!2sid!4v1688812399840!5m2!1sen!2sid" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
          
          
          <div class="katae col-12 col-md-4 col-lg-6 col-sm-12 mt-5 ms-4" style="align-self: center;">
            <div class="card ">
              <div class="card-header" style="background-color: #ff3900;">
              <h4 style="color: #ffffff;"> <i class="bi bi-geo-alt" style="color:#ffffff"></i> Address</h4>
              </div>
              <div class="card-body">
