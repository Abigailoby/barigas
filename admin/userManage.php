...
<div class="container-fluid" style="margin-top:98px">
    ...
    <br>
    <div class="row" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="100">
                    ...
                    <table class="table-striped table-bordered col-md-12 text-center">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                    <td>' . $Id . '</td>
                                    <td><img src="/barigas/image/urang-' . $Id . '.jpg" alt="image for this user" onError="this.src =\'/barigas/image/profilePic.jpg\'" width="100px" height="100px"></td>
                                    <td>' . $username . '</td>
                                    <td class="p-3">
            ...
            <div class="modal-body">
                <form action="partials/_userManage.php" method="post">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="username" name="username" placeholder="Nama Pengguna" type="text" required minlength="3" maxlength="11" oninvalid="this.setCustomValidity('Masukkan Nama Pengguna')" oninput="this.setCustomValidity('')">
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <b><label for="firstName">Nama Depan:</label></b>
                            <input type="text" class="form-control" id="firstName" name="firstName" placeholder="Nama Depan" required oninvalid="this.setCustomValidity('Masukkan Nama Depan')" oninput="this.setCustomValidity('')">
                        </div>
                        <div class="form-group col-md-6">
                            <b><label for="lastName">Nama Belakang:</label></b>
                            <input type="text" class="form-control" id="lastName" name="lastName" placeholder="Nama Belakang" required oninvalid="this.setCustomValidity('Masukkan Nama Belakang')" oninput="this.setCustomValidity('')">
                        </div>
                    </div>
                    <div class="form-group">
                        <b><label for="email">Email:</label></b>
                        <input type="email" class="form-control" id="email" name="email" placeholder="Masukkan Email" required oninvalid="this.setCustomValidity('Email harus memuat karakter @')" oninput="this.setCustomValidity('')">
                    </div>
                    <div class="form-group row my-0 mt-3">
                        <div class="form-group col-md-6 my-0">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="tel" class="form-control" id="phone" name="phone" placeholder="Masukkan no HP" required pattern="[0-9]{11,}" maxlength="13" oninvalid="this.setCustomValidity('Harus berisi angka dan panjangnya 11 digit.')" oninput="this.setCustomValidity('')">
                            </div>
                        </div>
                        <div class="form-group col-md-6 my-0">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="password" name="password" placeholder="Masukkan Kata Sandi" type="password" required data-toggle="password" minlength="4" maxlength="21" oninvalid="this.setCustomValidity('Masukkan Kata Sandi')" oninput="this.setCustomValidity('')">
                    </div>
                    <div class="form-group">
                        <b><label for="password1">Konfirmasi Kata Sandi:</label></b>
                        <input class="form-control" id="cpassword" name="cpassword" placeholder="Konfirmasi Kata Sandi" type="password" required data-toggle="password" minlength="4" maxlength="21" oninvalid="this.setCustomValidity('Masukkan Kata Sandi')" oninput="this.setCustomValidity('')">
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                        ...
                        <div class="form-group col-md-4">
                            <img src="/barigas/image/urang-<?php echo $Id; ?>.jpg" alt="Profile Photo" width="100" height="100" onError="this.src ='/barigas/image/profilePic.jpg'">
                            <form action="partials/_userManage.php" method="post">
                                <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
                        ...
                        <div class="form-group row my-0 mt-3">
                            <div class="form-group col-md-6 my-0">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="phone" name="phone" value="<?php echo $phone; ?>" required pattern="[0-9]{11,}" maxlength="13">
                                </div>
                            </div>
                            <div class="form-group col-md-6 my-0">
