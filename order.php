...
<body>
    ...
    <?php 
        ...
        <div class="alert alert-info my-3">
            <font style="font-size:22px"><center>Untuk Melihat Pesanan Anda. Anda harus  <strong><a class="alert-link" data-bs-toggle="modal" data-bs-target="#loginModal" style="cursor: pointer;">Login</a></strong></center></font>
        </div></div>';
    }
    ?>
